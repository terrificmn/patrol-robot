...
int main(int argc, char **argv)
{
    ...
    ros::Subscriber sub_depth = n.subscribe("l515/depth/image_rect_raw", 1, depthCallback, ros::TransportHints().udp());
    //ros::Subscriber sub_depth = n.subscribe("l515/depth/color/points", 1, depthCallback, ros::TransportHints().udp());
